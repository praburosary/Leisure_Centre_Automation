...
public class Booking {
    ...
    public void browser_actions() throws InterruptedException {
        ...
        if ((timeNow.equals(LocalTime.of(9, 01)) || timeNow.isAfter(LocalTime.of(9, 01))) && timeNow.isBefore(LocalTime.of(9, 31))) {
            clickSelectCourtByTime(page, "09:30");
        } else if ((timeNow.equals(LocalTime.of(10, 01)) || timeNow.isAfter(LocalTime.of(10, 01))) && timeNow.isBefore(LocalTime.of(10, 31))) {
            clickSelectCourtByTime(page, "10:30");
        } else if ((timeNow.equals(LocalTime.of(11, 01)) || timeNow.isAfter(LocalTime.of(11, 01))) && timeNow.isBefore(LocalTime.of(11, 31))) {
            clickSelectCourtByTime(page, "11:30");
        } else if ((timeNow.equals(LocalTime.of(12, 01)) || timeNow.isAfter(LocalTime.of(12, 01))) && timeNow.isBefore(LocalTime.of(12, 31))) {
            clickSelectCourtByTime(page, "12:30");
        } else if ((timeNow.equals(LocalTime.of(13, 01)) || timeNow.isAfter(LocalTime.of(13, 01))) && timeNow.isBefore(LocalTime.of(13, 31))) {
            clickSelectCourtByTime(page, "13:30");
        } else if ((timeNow.equals(LocalTime.of(14, 01)) || timeNow.isAfter(LocalTime.of(14, 01))) && timeNow.isBefore(LocalTime.of(14, 31))) {
            clickSelectCourtByTime(page, "14:30");
        } else if ((timeNow.equals(LocalTime.of(15, 01)) || timeNow.isAfter(LocalTime.of(15, 01))) && timeNow.isBefore(LocalTime.of(15, 31))) {
            clickSelectCourtByTime(page, "15:30");
        } else if ((timeNow.equals(LocalTime.of(16, 01)) || timeNow.isAfter(LocalTime.of(16, 01))) && timeNow.isBefore(LocalTime.of(17, 31))) {
